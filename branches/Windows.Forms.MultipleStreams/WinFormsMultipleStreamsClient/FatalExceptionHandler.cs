...
namespace WinFormsMultipleStreamsClient
{
	...
	public partial class FatalExceptionHandler : Form
	{
		public FatalExceptionHandler(System.Exception e)
		{
			...
			this.ExceptionBox.Text = "Following exception occurred while running TheLastRipper:\r\n" + VersionInfo.FileVersion + " \r\n$Revision: 266 $\r\n" + e.ToString().Replace("\n","\r\n");
			this.infoLabel.Text = "An unexpected exception has occurred which resulted in a crash. You may help improve TheLastRipper by submitting a bug report to the developer team. You must include following information that may help developers solve your problem:\n - What were you doing at the time of the crash?\n - Has this happened before?\n - How to reproduce this issue?\n - Information about your system\n - And the exception shown in the textbox below.\nPlease help the developer team by checking that your issue haven't been reported, before submitting it; if already reported please confirm it, provide additional information and/or subscribe to it to be notified whenever there's a change.";
		}
		
		
		void ButtonCloseClick(object sender, EventArgs args)
		{
			this.Close();
		}
	}
